...
import { ChevronLeft, Mouse } from "lucide-react"
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="p-3 bg-green-500/10 rounded-xl border border-green-500/20">
              <Mouse className="h-8 w-8 text-green-400" />
            </div>
            <div>
              <h1 className="text-4xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-400">
                Mouse Test
              </h1>
              <p className="text-neutral-400 mt-2">
                Test buttons, scroll wheel, tracking, and polling rate
              </p>
            </div>
          </div>
        </div>
